...
namespace SPAVUE.Util
{
	public class MimeHelper
	{
		...
		/// 类型和文件夹映射关系
		/// </summary>
		private static Dictionary<string, string> typeDict = new Dictionary<string, string>(StringComparer.CurrentCultureIgnoreCase)
		{
			{
				".323",
				"00"
		...
		public static string GetMineType(string fileName)
		{
			...
			if (_mimeMappingDict.TryGetValue(key, out value))
			{
				return value;
			}
			return string.Empty;
