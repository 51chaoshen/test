...
namespace SPAVUE.Migrations
{
    ...
    [Migration("20200528062057_updatePersonName")]
    partial class updatePersonName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPAVUE.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SPAVUE.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SPAVUE.Authorization.Users.User", null)
                        .WithMany("Claims")
