...
namespace SPAVUE.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly SPAVUEDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = SPAVUEConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SPAVUEDbContext context)
        {
            _context = context;
        }
