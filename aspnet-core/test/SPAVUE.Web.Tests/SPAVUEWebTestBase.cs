...
namespace SPAVUE.Web.Tests
{
    public abstract class SPAVUEWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SPAVUEWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SPAVUEWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SPAVUEDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SPAVUEDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SPAVUEDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SPAVUEDbContext, Task<T>> func)
        {
            T result;
